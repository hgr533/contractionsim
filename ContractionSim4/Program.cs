...
public class TzimtzumSimulation
{
    ...
    public class QuantumCircuit
    {
        ...
        public void ApplyEntanglement(EntanglementEnergy battery)
        {
            if (battery.SupplyEntanglement(1.0))
            {
        ...
        public void ReverseEntanglement(EntanglementEnergy battery)
        {
            if (battery.AbsorbEntanglement(1.0))
            {
